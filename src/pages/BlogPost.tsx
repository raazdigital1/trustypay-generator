    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 pb-16">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          {post?.content && (
            <div
              className="prose prose-neutral dark:prose-invert max-w-none text-foreground overflow-hidden [overflow-wrap:break-word] [word-break:break-word] [&_*]:max-w-full [&_p]:hyphens-none [&_li]:hyphens-none [&_h1]:hyphens-none [&_h2]:hyphens-none [&_h3]:hyphens-none [&_a]:break-all [&_img]:h-auto [&_pre]:overflow-x-auto [&_table]:block [&_table]:overflow-x-auto"
